...
const CHIEF_USERS = [
  { name: "Nate", password: "get lost punk", house: "Catalina" },
  { name: "Rosie", password: "get lost punk", house: "Rincon" },
  { name: "Amrutha", password: "get lost punk", house: "Santa Rita" },
  { name: "Will", password: "get lost punk", house: "Tortolita" },
  { name: "Johnny", password: "get lost punk", house: "Tucson" },
];
...
function runSelfTests() {
  ...
  console.assert(authenticateChief("Nate", "get lost punk") && authenticateChief("Nate", "get lost punk").house === "Catalina", "Chief login should authenticate known chief");
