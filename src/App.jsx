...
function runSelfTests() {
  console.assert(HOUSES.length === 5, "There should be five houses.");
  console.assert(ACTIVITIES.some((activity) => activity.id === "point_pitch"), "Point pitch activity should exist.");
...
export default function App() {
  ...
  const canLog = name.trim().length > 0 && house !== null;
  ...
  async function shareCSV() {
    ...
    const headers = ["timestamp", "name", "house", "activity", "points", "status", "note"];
    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.container}>
        <View style={styles.headerPill}>
          <Text style={styles.headerPillText}>🏔️ UA Internal Medicine House Cup</Text>
        </View>
        ...
        <View style={styles.actionRow}>
          ...
          <Pressable style={styles.dangerButton} onPress={clearEntries}>
            <Text style={styles.dangerButtonText}>Clear</Text>
          </Pressable>
        </View>

        <Text style={styles.footerText}>
          Simple scoring: Conference 1 · Group 2 · Academic 3 · Wellness/community 3 · Monthly wellness 5 · Big Tucson 5+. Keep the vibe fun, not forensic.
        </Text>
      </ScrollView>
    </SafeAreaView>
  );
